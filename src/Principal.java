...
public class Principal {
    public static void main(String[] args) {
        ...
        //ORDENAR COMPRAS implementar en clase compras para comparar con otras compras IR A CLASE COMPRA
        Collections.sort(tarjeta.getListaDeCompras());

        for (Compra compra : tarjeta.getListaDeCompras()) {
            System.out.println(compra.getDescripción() + "-" + compra.getValor());
